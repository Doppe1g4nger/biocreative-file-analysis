...
if __name__ == "__main__":
    dis_training_ids = abs_extract.get_training_set_pmid(  # edit this
    ...
    id_to_abstract = {}
    count = 0
    abstracts = BioCObject(r"/home/daniel/Downloads/abstracts_collection.xml").abstracts()  # edit this
    temp = list(abstracts.keys())  # may need to edit this
    ...
    with open(r"/home/daniel/Downloads/dis_irrelevant_abstracts.pkl", "wb") as file:  # edit this
