...
if __name__ == "__main__":
    ontologies = ["NCIT", "DOID", "HP", "ICD10CM", "IDO", "MESH", "OAE", "ORDO", "PDO", "RCD", "SNOMEDCT"]
    # all_terms = get_restricted_ncit_terms()  # Don't need if not restricting terms
    ...
    for ontology in ontologies:
        with open(r"C:\Users\Danie\Downloads\dis_irrelevant_set_NCBO_test_" + ontology + ".txt", "w") as file:
            ...
            tot_annotations = 0
            id_to_abstract = {}
            with open(r"C:\Users\Danie\Downloads\dis_irrelevant_abstracts.pkl", "rb") as f:
            ...
            for abs_id in id_to_abstract:
                ...
                for item in json_response:
                    for annotation in item["annotations"]:
                        # if annotation["text"].strip().lower() in all_terms:  # Uncomment for restricted NCIT terms
                        num_annotations += 1
